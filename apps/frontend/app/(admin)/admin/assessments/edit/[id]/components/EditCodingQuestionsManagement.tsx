...
interface EditCodingQuestionsManagementProps {
  formData: any;
...
export function EditCodingQuestionsManagement({
  formData,
  onInputChange,
  sections,
}: EditCodingQuestionsManagementProps) {
  ...
  const codingQuestions = formData.codingQuestions || [];
  ...
  const addCodingQuestion = () => {
    ...
    onInputChange('codingQuestions', [...existingQuestions, newCodingQuestion]);
    setSelectedTest('');
    setSelectedSection('');
    setScore(10);
  };
  ...
  const removeCodingQuestion = (index: number) => {
    const updatedQuestions = codingQuestions.filter(
      (_: any, i: number) => i !== index
    );
    onInputChange('codingQuestions', updatedQuestions);
  };
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              {codingQuestions.length === 0 ? (
                ...
                <div className="space-y-2">
                  {codingQuestions.map((codingQuestion: any, index: number) => {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="bg-blue-600">
                    {codingQuestions.reduce(
                      (sum: number, cq: any) => sum + cq.score,
                      0
                    )}{' '}
                    points
                  </Badge>
