# Fix isolate_job.rb
sudo cp /api/app/jobs/isolate_job.rb /api/app/jobs/isolate_job.rb.bak
sudo bash -c 'cat > /api/app/jobs/isolate_job.rb << "EOF"
...
sudo bash -c 'cat >> /api/app/models/submission.rb << "EOF"
